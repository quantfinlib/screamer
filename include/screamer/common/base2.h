...
namespace screamer {
    ...
    bool try_py_object_as_double(const py::object& obj, double& result) {

        if (py::isinstance<py::float_>(obj) ||
            py::isinstance<py::int_>(obj) ||
            py::isinstance<py::bool_>(obj)
        ) {
            result = py::cast<double>(obj);
            return true;
        }
    ...
    bool py_object_as_array_t(const py::object& obj, py::array_t<double>& ans) {
        if (py::isinstance<py::array>(obj) ||
            py::isinstance<py::list>(obj) ||
            py::isinstance<py::tuple>(obj)
        ) {
            ans = py::cast<py::array_t<double>>(obj);
            return true;
        }    
    ...
    bool object_as_iterable(const py::object& obj, py::iterable& ans) {
    ...
    public:
        ...
        py::object operator()(py::object input) {
            ...
            if (py::isinstance<py::iterable>(input)) {
                return py::cast(std::make_shared<LazyIterator>(input.cast<py::iterable>(), *this));
            }
