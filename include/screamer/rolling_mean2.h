#ifndef SCREAMER_ROLLING_MEAN2_H
#define SCREAMER_ROLLING_MEAN2_H
...
namespace screamer {
    ...
    class RollingMean2 : public ScreamerBase {
    public:

        RollingMean2(int window_size) : 
